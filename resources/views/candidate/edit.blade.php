    ...
    <form action="{{ route('candidate.update' , $candidate->id ) }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="registration" id="reg_no" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="e.g., REG004" required value="{{ $candidate->registration }}">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="e.g., Alex Johnson" required value="{{ $candidate->name }}">
            ...
            <div>
                ...
                <input type="text" name="remarks" id="remarks" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="e.g., Alex Johnson" required value="{{ $candidate->remarks }}">
